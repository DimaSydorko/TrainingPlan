...
import { Text, StyleSheet, Animated, TouchableWithoutFeedback, StyleProp, TextStyle, ViewStyle } from 'react-native'
...
export class SwitchLib extends Component<SwitchProps, SwitchState> {
  static defaultProps = {
    value: false,
    onValueChange: () => null,
  ...
  constructor(props, context) {
    ...
    this.state = {
      ...
      transformSwitch: new Animated.Value(
        props.value ? props.circleSize / props.switchLeftPx : -props.circleSize / props.switchRightPx
      ),
